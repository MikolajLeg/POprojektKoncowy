...
from DataGrinder import DataGrinder
from Wykres import Rysuj
from Buttons import CountryButton, ChoiceButton ,PathButton ,AddPatchButton
from PyQt5.QtWidgets import QMainWindow, QVBoxLayout, QGroupBox,QWidget, QGridLayout, QPushButton,QTabWidget, QLineEdit
...
#twrzorzy liste CountryButons na podstawie dostarczonej listy (wszystkich) państw
    def prep_lista(self):
        self.tab2 = QWidget()
    ...
    def refresh_view(self):
        ...
        Inputer = PathButton(self)
        self.__layout.addWidget((Inputer), 0, 20, 2, 6)
        self.__layout.addWidget(AddPatchButton("Dodaj Plik",self,Inputer), 0, 26, 2, 2)
